...
export function CharacterGeneratorPage() {
  ...
  const [generatedVariations, setGeneratedVariations] = useState<Array<{num: number, image: string, selected: boolean}>>([]);
  ...
  const handleVariationsGenerated = (variations: Array<{num: number, image: string, selected: boolean}>) => {
